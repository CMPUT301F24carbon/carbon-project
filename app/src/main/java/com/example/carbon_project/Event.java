...
// 6. getQRCodeBitmap       Return the QR code Bitmap generated by the eventId
// 7. getPosterUri          Return the poster URI  <- Not work, still trying to fix
...
// Never use getQRCodeHash(), this is only for US 02.01.02: QR code should be stored in hash format.
...
public class Event {
    ...
    /**
     * Generates a QR code image in hash.
     * @return QR code hashed string.
     */
    public String getQRCodeHash() {
        try {
            ...
            for (byte b : hashBytes) {
                hexString.append(String.format("%02x", b));  // Format each byte as 2-digit hex
            }
    ...
    /**
     * Generates a QR code image in Bitmap format.
