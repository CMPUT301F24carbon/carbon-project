...
// 1. loadFromFirestore     Load event data from Firestore and update the instance variables
...
// 5. removeEntrant         Removes an entrant from the waitingList or, if already selected, removes the entrant from the selectedList instead
...
public class Event {
     ...
     */
    public Event(String eventId, String name, String location, int capacity, boolean geolocationRequired, String startDate, String endDate, int waitingListLimit, String posterUri) {
        this.eventId = eventId;
